...
const nations: Nation[] = [
  ...
  },
  {
    ...
    character: "Érudit · Guerrier · Ordonné", accent: "#b0adad", glow: "rgba(176,173,173,0.12)",
    nationHref: "#", leaderHref: "#", status: "active",
  ...
  },
  {
    ...
    character: "Sombre · Interdit · Menaçant", accent: "#FF4A4A", glow: "rgba(255,74,74,0.12)",
    nationHref: "#", leaderHref: "#", status: "active",
  ...
  },
  {
    ...
    description: "Région reculée du nord ne connaissant que la loi de la jungle. Douze tribus souveraines ; un conseil tous les 122 nuits.",
    character: "Tribal · Sauvage · Isolé", accent: "#6fcf6f", glow: "rgba(111,207,111,0.12)",
    nationHref: "#", leaderHref: "#", status: "active",
  ...
  // ── Inconnues ─────────────────────────────────────────────────────────────────
  {
    ...
    army: { name: "??? — à définir", total: "???", description: "Les données militaires n'ont pas encore été renseignées.", units: [{ name: "À compléter", count: "???", role: "Informations à venir" }] },
  },
  {
  ...
  // ── Disparues ─────────────────────────────────────────────────────────────────
  {
    ...
    army: { name: "— Dissoute —", total: "Nation disparue", description: "L'armée de Saltir fut décimée. Ses cavaliers se soulevèrent, ses côtes furent attaquées. Aucun secours ne vint.", units: [{ name: "Cavaliers du Désert", count: "†", role: "Se soulevèrent contre leur propre nation" }, { name: "Garnisons Côtières", count: "†", role: "Écrasées lors du débarquement d'Hokkaido" }] },
  },
  {
        ...
        <div className="grid md:grid-cols-[2fr_1fr]">
          ...
          <div className="flex flex-col p-7 border-t md:border-t-0 md:border-l" style={{ borderColor: `${nation.accent}20` }}>
            <div className="flex items-center gap-2 mb-4">
              <svg className="w-3.5 h-3.5 shrink-0 text-[#4A5568]/40" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mb-6">
              <p className="font-cinzel text-[10px] tracking-[0.25em] uppercase text-[#4A5568]/40 mb-2">Caractère</p>
