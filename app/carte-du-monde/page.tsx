...
const nations = [
  {
    ...
    color: "#0fea08",
    // Île nord-ouest : contour vert sur la carte nord
    points: [
  ...
  },
  {
    ...
    color: "#0a0403",
    // Grand territoire brun nord-est (hors Tengoku)
    points: [
  ...
  },
  {
    ...
    color: "#a0a3a3",
    // Enclave blanche/glacée dans Dakurodo, centre-est
    points: [
  ...
  },
  {
    ...
    color: "#e6c532",
    // Désert sablé nord, large ellipse
    points: [
  ...
  },
  {
    ...
    color: "#747171",
    // Grand territoire sombre sud-centre-ouest
    points: [
  ...
  },
  {
    ...
    color: "#eb8628",
    // Bleu, large zone centre-est/droite
    points: [
