...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-[#D4C5A9] shadow-md" />
  </NavigationMenuPrimitive.Indicator>
))
